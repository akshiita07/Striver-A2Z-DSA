...
int main()
{
    ...
    // binary:1001
    int k1 = 1;
    cout << "\nBRUTE FORCE->Number after clearing " << k1 << " bit of " << n << " is= " << brute_force(n, k1);
    cout << "\nNumber after clearing " << k1 << " bit of " << n << " is= " << clearKthBit(n, k1);
    int k2 = 2;
    cout << "\nBRUTE FORCE->Number after clearing " << k2 << " bit of " << n << " is= " << brute_force(n, k2);
    cout << "\nNumber after clearing " << k2 << " bit of " << n << " is= " << clearKthBit(n, k2);
