...
public:
    vector<vector<char>> rotateTheBox(vector<vector<char>>& box) {
        ...
        // some stones fall due to gravity until it lands on obstacle/another stone/bottom of the box Return an n x m matrix representing the box after the rotation
