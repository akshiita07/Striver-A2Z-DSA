...
public:
    ...
    void generateHappyStrings(int n, string current,
        ...
        for (char ch : {'a', 'b', 'c'}) {
            // if it is starting letter OR if last character & this character
            // are NOT same
    ...
    string getHappyString(int n, int k) {
        ...
        // s[i] != s[i + 1]
        // create a list of happy strings of length n sorted in lexicographical
        // order return k-th string of this list else empty string
        vector<string> happyStrings;
