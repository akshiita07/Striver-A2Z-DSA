...
public:
    ...
    int maxTwoEvents(vector<vector<int>>& events) {
        ...
        // if you attend an event with end time t, the next event must start at
        // or after t + 1 choose 2 or less non-overlapping events to attend st
        // sum of their values is maximized. return max sum
        int n = events.size();
